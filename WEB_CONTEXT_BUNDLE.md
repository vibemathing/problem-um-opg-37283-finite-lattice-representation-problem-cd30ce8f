...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37283"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-v1",
      "problem_contract_sha256": "3828bfba39857284f1cf3fff81a7d66195af764ff49846e28864d070126ebc25",
      "problem_id": "problem:um-opg-37283-finite-lattice-representation-problem-cd30ce8f",
      "route_id": "route:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-source-fidelity-01",
      "graph_id": "graph:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture There exists a finite lattice which is not the congruence lattice of a finite algebra."
          },
          "statement_sha256": "909473158adb8dc916980a54c9da339b3a06b3335614d3f58a12111ae9fce2b9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-root",
      "route_id": "route:um-opg-37283-finite-lattice-representation-problem-cd30ce8f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37283-648be1c3100e",
        "url": "https://www.unsolvedmath.com/problems/OPG-37283"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
